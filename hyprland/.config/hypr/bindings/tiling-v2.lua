...
hl.bind("SUPER + F", hl.dsp.window.fullscreen({ mode = "maximized" }), { description = "Full screen" })
...
hl.bind("SUPER + CTRL + RIGHT", hl.dsp.focus({ workspace = "e+1" }), { description = "Scroll active workspace forward" })
hl.bind("SUPER + mouse_up", hl.dsp.focus({ workspace = "e-1" }), { description = "Scroll active workspace backward" })
hl.bind("SUPER + CTRL + LEFT", hl.dsp.focus({ workspace = "e-1" }), { description = "Scroll active workspace backward" })
...
-- Join groups
hl.bind("SUPER + ALT + LEFT", hl.dsp.window.move({ into_group = "left" }), { description = "Move window to group on left" })
hl.bind("SUPER + ALT + RIGHT", hl.dsp.window.move({ into_group = "right" }), { description = "Move window to group on right" })
hl.bind("SUPER + ALT + UP", hl.dsp.window.move({ into_group = "up" }), { description = "Move window to group on top" })
hl.bind("SUPER + ALT + DOWN", hl.dsp.window.move({ into_group = "down" }), { description = "Move window to group on bottom" })
